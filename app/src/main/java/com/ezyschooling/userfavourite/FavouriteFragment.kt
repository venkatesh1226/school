...
class FavouriteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View= inflater.inflate(R.layout.fragment_favourite, container, false)
        this.ctx = context!!
        init(view)
        api()
    ...
    fun api(){
       RetrofitClient.context=ctx
        instance1.likedArticles().enqueue(object: Callback<resultArticles>{
        ...
        instance1.likedVideos().enqueue(object:Callback<resultVideos>{
        ...
        instance1.likedDiscussions().enqueue(object:Callback<resultDiscussions>{
